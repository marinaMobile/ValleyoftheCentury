package com.chillyroom.z.black
...
import com.chillyroom.z.black.CNST.C1
import com.chillyroom.z.black.CNST.D1
import com.chillyroom.z.black.CNST.DEV
import com.chillyroom.z.white.Gaming
        ...
        runBlocking {
            try {
                ...
                if (jsoup == CNST.jsoupCheck) {
                    Intent(applicationContext, Gaming::class.java).also { startActivity(it) }
                } else {
